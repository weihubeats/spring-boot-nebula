...
public class CompletableFutureUtils {
    ...
    private static class DefaultExecutorHolder {
        ...
        private static ExecutorService buildDefaultExecutor() {
            ...
            Runtime.getRuntime().addShutdownHook(new Thread(() ->
                shutdown(pool, 5, TimeUnit.SECONDS)));
            return pool;
        }
    }
    ...
    public static <R1, R2> Tuple2<R1, R2> allSupplyAndGet(Supplier<R1> s1,
        ...
        @SuppressWarnings("unchecked") R1 r1 = (R1) arr[0];
        @SuppressWarnings("unchecked") R2 r2 = (R2) arr[1];
    ...
    public static <R1, R2, R3> Tuple3<R1, R2, R3> allSupplyAndGet(Supplier<R1> s1,
        ...
        @SuppressWarnings("unchecked") R1 r1 = (R1) arr[0];
        @SuppressWarnings("unchecked") R2 r2 = (R2) arr[1];
        @SuppressWarnings("unchecked") R3 r3 = (R3) arr[2];
    ...
    public static <R1, R2, R3, R4> Tuple4<R1, R2, R3, R4> allSupplyAndGet(Supplier<R1> s1,
        ...
        @SuppressWarnings("unchecked") R2 r2 = (R2) arr[1];
        @SuppressWarnings("unchecked") R3 r3 = (R3) arr[2];
        @SuppressWarnings("unchecked") R4 r4 = (R4) arr[3];
    ...
    public static <R1, R2, R3, R4, R5> Tuple5<R1, R2, R3, R4, R5> allSupplyAndGet(Supplier<R1> s1,
        ...
        @SuppressWarnings("unchecked") R3 r3 = (R3) arr[2];
        @SuppressWarnings("unchecked") R4 r4 = (R4) arr[3];
        @SuppressWarnings("unchecked") R5 r5 = (R5) arr[4];
        ...
        for (CompletableFuture<?> f : futures) {
            if (f.isCompletedExceptionally() || f.isCancelled()) {
                try {
                    ...
                    if (cause instanceof CancellationException) {
                        if (firstCancellation == null) firstCancellation = cause;
                    } else {
                        return cause != null ? cause : ce;
                    }
                } catch (CancellationException ce) {
                    if (firstCancellation == null) firstCancellation = ce;
                }
            }
        }
    ...
    private static <T> T blockingGet(CompletableFuture<T> future, long timeout, TimeUnit unit)
        throws CompletableException {
        try {
